...
import pub.lhp.domain.strategy.model.valobj.*;
import pub.lhp.domain.strategy.repository.IStrategyRepository;
import pub.lhp.infrastructure.persistent.dao.*;
import pub.lhp.infrastructure.persistent.po.*;
...
import static pub.lhp.types.enums.ResponseCode.UN_ASSEMBLED_STRATEGY_ARMORY;
...
public class StrategyRepository implements IStrategyRepository {
    ...
    public List<StrategyAwardEntity> queryStrategyAwardList(Long strategyId) {
        String cacheKey = Constants.RedisKey.STRATEGY_AWARD_LIST_KEY + strategyId; // big_market_strategy_award_list_key_100001
        // 1.查询缓存
    ...
    public RuleTreeVO queryRuleTreeVOByTreeId(String treeId) {
        ...
        // TODO: 后期这里可以加上缓存时间，也就是，如果有了活动过期时间，那么这里的缓存时间就是活动过期时间
